...
class _IndexPageState extends State<IndexPage> {
  ...
  void initState() {
    super.initState();
    tasks = [
      TaskModel(purple, TimePadIcon.monitor, "UI Design",
          ["Work", "Rasion Project"], Duration(minutes: 30, hours: 2), "inactive"),
      TaskModel(orange, TimePadIcon.barbell, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 15, hours: 5), "inactive"),
      TaskModel(pink, TimePadIcon.code, "UI Design", ["Work", "Rasion Project"],
          Duration(minutes: 20, hours: 22), "inactive"),
      TaskModel(green, TimePadIcon.book, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 45, hours: 0), "inactive"),
      TaskModel(purple, TimePadIcon.monitor, "UI Design",
          ["Work", "Rasion Project"], Duration(minutes: 23, hours: 1), "inactive"),
      TaskModel(orange, TimePadIcon.barbell, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 48, hours: 17), "inactive"),
      TaskModel(pink, TimePadIcon.code, "UI Design", ["Work", "Rasion Project"],
          Duration(minutes: 19, hours: 93), "inactive"),
      TaskModel(green, TimePadIcon.book, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 50, hours: 8), "inactive"),
      TaskModel(purple, TimePadIcon.monitor, "UI Design",
          ["Work", "Rasion Project"], Duration(minutes: 34, hours: 6), "inactive"),
      TaskModel(orange, TimePadIcon.barbell, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 7, hours: 11), "inactive"),
      TaskModel(pink, TimePadIcon.code, "UI Design", ["Work", "Rasion Project"],
          Duration(minutes: 59, hours: 17), "inactive"),
      TaskModel(green, TimePadIcon.book, "API Setup",
          ["Backend", "Node JS", "Express"], Duration(minutes: 22, hours: 21), "inactive")
    ];
